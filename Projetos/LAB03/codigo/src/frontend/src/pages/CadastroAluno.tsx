...
export default function CadastroAluno() {
  return (
    <div>
      <PageHeader title="Cadastro de Aluno" action={<span className="text-sm text-slate-500">Cadastro de Aluno</span>} />
      <div className="card p-4">
        <h3 className="font-medium mb-4">Informações do Aluno</h3>
